...
def train_neural_net(path, with_plots):
    ...
    if not with_plots:
        print('Training 1')
        model_1 = MLPClassifier(solver='sgd', validation_fraction=0.0, alpha=1e-1, hidden_layer_sizes=(5,), random_state=1).fit(x_train, y_train)
        print('Training 2')
        model_2 = MLPClassifier(solver='sgd', validation_fraction=0.0, alpha=1e-3, hidden_layer_sizes=(40,), random_state=1).fit(x_train, y_train)
        print('Training 3')
        model_3 = MLPClassifier(solver='sgd', validation_fraction=0.0, alpha=1e-3, hidden_layer_sizes=(5, 5), random_state=1).fit(x_train, y_train)
        print('Training 4')
        model_4 = MLPClassifier(solver='sgd', validation_fraction=0.0, alpha=1e-3, hidden_layer_sizes=(40, 40), random_state=1).fit(x_train, y_train)
...
def train_neural_net_with_loan_data(path, with_plots):
    ...
    if not with_plots:
        print('Training 1')
        model_1 = MLPClassifier(solver='sgd', validation_fraction=0.0, alpha=1e-3, hidden_layer_sizes=(20, 5), random_state=1).fit(x_train, y_train)
        print('Training 2')
        model_2 = MLPClassifier(solver='sgd', validation_fraction=0.0, alpha=1e-3, hidden_layer_sizes=(50, 5), random_state=1).fit(x_train, y_train)
        print('Training 3')
        model_3 = MLPClassifier(solver='sgd', validation_fraction=0.0, alpha=1e-3, hidden_layer_sizes=(100, 5), random_state=1).fit(x_train, y_train)
        print('Training 4')
        model_4 = MLPClassifier(solver='sgd', validation_fraction=0.0, alpha=1e-3, hidden_layer_sizes=(500, 5), random_state=1).fit(x_train, y_train)
