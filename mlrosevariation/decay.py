...
class GeomDecay:
    ...
    * :math:`T_{min}` is the minimum temperature value.
    ...
    .. highlight:: python
    .. code-block:: python
        >>> import mlrosevariation
        >>> schedule = mlrosevariation.GeomDecay(init_temp=10, decay=0.95, min_temp=1)
        >>> schedule.evaluate(5)
        7.73780...
    """
...
class ArithDecay:
    ...
    * :math:`T_{min}` is the minimum temperature value.
    ...
    .. code-block:: python
        >>> import mlrosevariation
        >>> schedule = mlrosevariation.ArithDecay(init_temp=10, decay=0.95, min_temp=1)
        >>> schedule.evaluate(5)
        5.25
    """
...
class ExpDecay:
    ...
    * :math:`T_{min}` is the minimum temperature value.
    ...
    .. code-block:: python
       >>> import mlrosevariation
       >>> schedule = mlrosevariation.ExpDecay(init_temp=10, exp_const=0.05, min_temp=1)
       >>> schedule.evaluate(5)
       7.78800...
    """
...
class CustomSchedule:
    ...
    .. code-block:: python
        ...
        >>> kwargs = {'c': 10}
        >>> schedule = mlrosevariation.CustomSchedule(custom, **kwargs)
        >>> schedule.evaluate(5)
        15
    """
